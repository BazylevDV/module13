...
if __name__ == '__main__':
    ...
    async def start(message: types.Message, state: FSMContext):
        await message.answer("Дорогие женщины, ваш слуга - бот посчитает для Вас сейчас оптимальное количество калорий по формуле  Миффлина - Сан Жеора, процедура займет 5 секунд. Далее нажмите кнопку 'Рассчитать' чтобы начать подсчет калорий или 'Информация' для получения дополнительной информации.", reply_markup=start_keyboard)
